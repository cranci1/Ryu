...
class SearchResultsViewController: UIViewController {
    ...
    private func showSourceSelector() {
        ...
        let sources = ["AnimeWorld", "GoGoAnime", "AnimeHeaven", "AnimeFire", "Kuramanime", "JKanime", "Anime3rb", "HiAnime", "Anilibria", "AnimeSRBIJA", "AniWorld"]
    ...
    private func getUrlAndParameters(for source: String) -> (url: String, parameters: Parameters)? {
        ...
        case "Kuramanime":
            url = "https://kuramanime.bid/anime"
